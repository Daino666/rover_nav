...
# Computed via forward kinematics from the actual URDF joint chain (not measured
# by hand): front axle track = 0.694m, mid/rear = 0.7147m. Weighted by the same
# 0.25/0.5/0.25 scheme used below for L/R position averaging -> 0.7095m.
# Previously hardcoded to 0.665m here, which didn't match the real geometry.
WHEEL_SEPARATION = 0.7095  # m

...
def test_axis_to_physical_wheel_mapping():
    """Re-verified 2026-08-23 after the node ids were reassigned, axis by axis.
    ...
    assert MODULE.AXIS_JOINTS == (
        "L_3_Wheel_Joint",  # axis 0 Front-Left
        "L_2_Wheel_Joint",  # axis 1 Middle-Left
        "L_1_Wheel_Joint",  # axis 2 Back-Left
        "R_1_Wheel_Joint",  # axis 3 Back-Right
        "R_2_Wheel_Joint",  # axis 4 Middle-Right
        "R_3_Wheel_Joint",  # axis 5 Front-Right
    )
